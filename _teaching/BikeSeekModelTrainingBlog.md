...
![[/images/Drawing 2025-08-13 11.15.11.png]]
...
![[/images/Pasted image 20250813113839.png]]
...
![[/images/Pasted image 20250813094001.png]]![[/images/Pasted image 20250813094102.png]]*(Left: Anchor Image; Middle: Positive Sample; Right: Negative Sample)*
...
1. **ViT-B-32:** We started out training one of the more light-weight models of the OpenCLIP family. The ViT-B-32 patches the input image into 32x32 patches. Due to this quite large patch-size and a fixed input resolution of 224x224, an input image will be divided into only $7\times 7$ tokens and hence the size of the subsequent attention matrices will be quite managable compared to the larger models of the OpenCLIP family. 
   The first experiment, taking AdamW as the optimizer with a moderate learning rate of $\text{lr}=10^{-3}$ or $\text{lr}=10^{-4}$ and setting the margin parameter $\alpha$ to $0.2$, we got the following intriguing result:    ![[Pasted image 20250623134755.png]]
...
2. **ViT-B-16:** 
   ...
   This model change, keeping all hyperparameters the same, got us the following results: ![[/images/Pasted image 20250813101750.png]]
